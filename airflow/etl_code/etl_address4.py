...
if __name__ == '__main__':
    mode_file_path = '.././data/lookups/4.address.json'
    if not os.path.exists(mode_file_path):
        address_dict = get_lookup_dict(".././data/lookups/address.txt", str, str, 1, 3, 6, -1)
        address_data = get_formatted_data_list(address_dict, "address_code", "address_name")
        save_as_formatted_JSON_file(".././data/lookups/4.address.json", "w", address_data)
